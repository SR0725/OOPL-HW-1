...
{
	if (character.Left() > chest_and_key.Left()- chest_and_key.Width()/2 && character.Left() < chest_and_key.Left() + chest_and_key.Width()/2) {
		if (character.Top() > chest_and_key.Top() - chest_and_key.Height()/2 && character.Top() < chest_and_key.Top() + chest_and_key.Height()/ 2) {
...
void CGameStateRun::OnInit()  								// 遊戲的初值及圖形設定
{
	...
	ball.SelectShowBitmap(0);
	ball.SetAnimation(10, true);
